...
import com.dalong.customviewstudy.asd;
...
public class ClockView extends View {
    ...
    private void drawRects(Canvas canvas) {
        ...
        canvas.drawRect(mWidth / 4, mHeght / 2 - 30, mWidth / 2 - 75, mHeght / 2 + 10, mPaint);
    ...
    private void drawStr(Canvas canvas) {
        ...
        String str = "星期五";
        canvas.drawText(str, mWidth / 4, mHeght / 2, mPaint);
    }
...
//                canvas.drawRect(mWidth /4, mHeght/2-30, mWidth /2-75, mHeght /2+10, mPaint);
                ...
                if (x >= mWidth / 4 && x <= mWidth / 2 - 75 && y >= mHeght / 2 - 30 && y <= mHeght / 2 + 10) {
                    System.out.println("aaaaaaaaaaaaaaa");
                    Intent intet = new Intent(getContext(), asd.class);
                    getContext().startActivity(intet);
                }
                break;
